          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardContent>
                ...
                <Typography variant="body2">Directories processed</Typography>
              </CardContent>
            </Card>
          </Grid>
                  ...
                  <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                      ...
                      <Chip
                        ...
                        size="small"
                        color={
                          scan.processedImages === scan.totalImages
                            ? "success"
                            : "warning"
                        }
                      />
              ...
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <Chip
                    ...
                    size="small"
                    color={
                      scanResults.iPhotoScan.processedImages ===
                      scanResults.iPhotoScan.totalImages
                        ? "success"
                        : "warning"
                    }
                  />
          ...
          <Paper elevation={1} sx={{ p: 3 }}>
            ...
            {isUploading && (
              <Box sx={{ mt: 2 }}>
                <LinearProgress
                  variant={
                    uploadProgress.total > 0 ? "determinate" : "indeterminate"
                  }
                  value={
              ...
              <Alert severity={uploadStatus.type} sx={{ mt: 2 }}>
                ...
                {uploadStatus.type === "success" && (
                  <Box sx={{ mt: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Go to the Chat interface to ask questions about your
                      documents.
                    </Typography>
                  </Box>
                )}
        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={1} sx={{ p: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Automatically scan your local directories and iPhoto library for
